...
from Utils.gui_save_nuc_loc import save_the_morphological_and_nuc_location_file
from Utils.gui_data_io import nib_load, check_folder, nib_save
...
def cell_morphological_analysis(base_path, selected_embryo, selected_model, output_path):
    ...
    stat_path = os.path.join(output_path, 'Statistics')
    ...
    for idx, embryo_name in enumerate(embryo_names):
        ...
        this_embryo_segmented_files = sorted(
            glob(os.path.join(segmented_root_path, embryo_name, selected_model, 'SegCellUnified', '*nii.gz')))
        ...
        save_the_morphological_and_nuc_location_file(name_dictionary_path, embryo_name, max_time,
                                                     os.path.join(os.path.dirname(segmented_root_path),
                                                                  'CDfiles', '{}.csv'.format(embryo_name)),
